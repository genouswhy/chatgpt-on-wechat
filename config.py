...
available_setting = {
    # openai api配置
    "open_ai_api_key": "sk-LOWV1cgxZAGCpQcVT0ESg8upONwAI91R3CbooY3G5f8xb3Gq",  # openai api key
    ...
    "moonshot_api_key": "sk-LOWV1cgxZAGCpQcVT0ESg8upONwAI91R3CbooY3G5f8xb3Gq",
